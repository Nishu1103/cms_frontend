  ...
  return (
    <>
      <div className="Reminders_mobile d-flex flex-column justify-content-center align-items-center mx-auto my-3">
        <div
          className="content-box py-3 px-3 px-md-4 py-md-3 mb-3"
          style={{ width: "100%" }}
        >
          <ArrowBackIosIcon
            style={{ fontSize: 30, position: "absolute", marginLeft: "5px" }}
          />
          <h6 className="d-flex justify-content-center ms-1 mb-4 fs-5">
            Reminders
          </h6>
          {reminders
            ...
            .map((reminder, index) => {
              ...
              return (
                ...
                >
                  <div className="d-flex flex-column Reminder px-2 py-2">
                    <div className="Reminder_mobile_className">
                      {reminder.className}
                    </div>
                    <div className="d-flex justify-content-between">
                      <div className="Reminder_Title_mobile">
                        {reminder.name}
                      </div>
          ...
          {reminderLoading ? (
            ...
            <div
              className="ms-1 mt-2 d-flex justify-content-center"
