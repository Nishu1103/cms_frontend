                  ...
                  <div className="Assignment_Box_student d-flex flex-column justify-content-center px-3 py-2">
                    <div className="d-flex mb-2">
                      ...
                      <div className="Post_Author d-flex flex-column justify-content-center mx-3">
                        ...
                        <div className="Post_AdminName">Admin</div>
                      </div>
                    </div>
                    <div className="Assignment_Img">
                      <img
                        src="https://media.istockphoto.com/photos/health-care-billing-statement-with-stethoscope-picture-id1224851166?b=1&amp;k=20&amp;m=1224851166&amp;s=170667a&amp;w=0&amp;h=xBJfeOFCnBG5Z6zgI2OFicnvgMF-idwwu3TuRvtq1y8="
                        alt=""
                      />
          ...
          <div className="col-md-5 col-lg-4 Upload_Options">
            ...
            <div className="mt-3">
              <form className="form-group">
                ...
                />
                {pdfFileError && (
                  <div className="error-msg text-danger">{pdfFileError}</div>
                )}
                {/* <br></br> */}
                {uploadState === 0 && (
                  <button
                  ...
                  <>
                    ...
                    {loading ? (
                      ...
                      <div className="d-flex justify-content-between">
                        ...
                        <button
                          onClick={btnClick_back}
                          type="button"
                          className={btn_class_1}
                        >
                          <strong>ReUpload</strong>
                        </button>
                      </div>
                    )}
                  </>
